...
namespace Proxies\__CG__\soleil\ecommerceBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ImageRealisation extends \soleil\ecommerceBundle\Entity\ImageRealisation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImageRealisation $proxy) {
